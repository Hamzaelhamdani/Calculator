...
import { CalculatorAdminModule } from './view/calculator/calculator-admin.module';
import { CalculatorAdminRoutingModule } from './view/calculator/calculator-admin-routing.module';
...
@NgModule({
  ...
  imports: [
    ...
    BadgeModule,
    MultiSelectModule,
  CalculatorAdminModule,
  CalculatorAdminRoutingModule,
   SecurityModule,
